...
export default function InstructorRegisterForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
      ...
      {/* NIC */}
      <Field label="NIC Number" required id="nicNumber" error={errors.nicNumber?.message}>
        <Input
          id="nicNumber"
      ...
      <p className="text-center text-xs text-gray-400">
        ...
        <Link href="/instructor/login" className="text-gray-500 hover:underline font-medium">
          Login
        </Link>
      </p>
    </form>
